...
export const metadata: Metadata = {
  title: "SignIn Page | Ameniti - Dashboard",
  description: "This is Signin Page Ameniti Admin Dashboard",
};
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-white outline-none focus:border-primary focus-visible:shadow-none"
                    />
